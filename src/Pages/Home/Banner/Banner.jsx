        ...
        <div>
            <div className="carousel w-full mb-16">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex items-center h-full left-0 top-0  bottom-0 rounded-xl bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                        <div className='text-white font-bold lg:space-y-7 lg:w-1/2 lg:pl-12'>
                            <h2 className='text-xl md:text-6xl text-white font-bold'> Dancing is Like dreaming With your foot!</h2>
                            <p className='text-sm md:text-4xl'>Learn From The Best Dance professionals</p>
                            <div>
                                <Link to="/classes">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex items-center h-full left-0 top-0  bottom-0 rounded-xl bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                        <div className='text-white font-bold lg:space-y-7 lg:w-1/2 lg:pl-12'>
                            <h2 className='text-xl md:text-6xl text-white font-bold'> Dance With Self Confidence</h2>
                            <p className='text-sm md:text-4xl'> Unleash your inner dancer and embark on an extraordinary journey of grace, expression, and self-discovery at Dance Academy.</p>
                            <div>
                                <Link to="/classes">
                                    <button className="btn btn-outline border-0 border-y-2 btn-error  mt-3">Take A Tour</button>
                                </Link>
